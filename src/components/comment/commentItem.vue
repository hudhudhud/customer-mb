<template>
  <div class="list-item" v-if="item">
    ...
    <div class="oth-item" v-if="canReplay&&item.children&&item.children.length">
...
<script>
import {  commentApprove, commentUp, commentAdd } from '@/api/articleApi'
import {  commentApprove as commentApproveVideo, commentUp as commentUpVideo, commentAdd as commentAddVideo } from '@/api/videoApi'
