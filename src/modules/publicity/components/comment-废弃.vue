<template>
  <div style="padding-bottom:56px;">
    <div class="bottom-fix">
      ...
      <div class="btns">
        <div class="btn" @click="handleComment" v-if="commentState"><i class="fa fa-commenting-o"></i><span>{{commentTotal || '评论'}}</span></div>
...
export default {
  ...
  methods: {
    ...
    // 是否能回复
    canReplay(item) {
      return this.commentState === 2 && (this.isAuthor || item.userId.toLocaleLowerCase()===this.userId.toLocaleLowerCase())&&item.children.length==0
    },
    addLinkEle(){
